...
INSERT INTO `sessions` VALUES ('2VvEgNOBz2j0eIDrFtMDGF0mPO_JmsEe',1699294055,'{\"cookie\":{\"originalMaxAge\":3600000,\"expires\":\"2023-11-06T18:07:23.064Z\",\"httpOnly\":true,\"path\":\"/\"},\"loginInfo\":{\"loginName\":\"문미경\",\"loginId\":\"moon\",\"loginPwd\":\"2222\"}}');
...
CREATE TABLE `메뉴단위` (
  ...
  `주문수량` int NOT NULL,
  `주문가격` int NOT NULL,
  `주문_주문날짜` varchar(20) NOT NULL,
  PRIMARY KEY (`메뉴항목_항목번호`,`고객_고객아이디`),
  KEY `fk_주문_has_메뉴항목_메뉴항목1_idx` (`메뉴항목_항목번호`),
  KEY `fk_메뉴단위_고객1_idx` (`고객_고객아이디`),
  KEY `fk_메뉴단위_주문1_idx` (`주문_주문날짜`),
  CONSTRAINT `fk_메뉴단위_고객1` FOREIGN KEY (`고객_고객아이디`) REFERENCES `고객` (`고객아이디`),
  CONSTRAINT `fk_메뉴단위_주문1` FOREIGN KEY (`주문_주문날짜`) REFERENCES `주문` (`주문날짜`),
...
INSERT INTO `메뉴항목` VALUES (101,'아메리카노',1500,'커피'),(102,'카페라떼',2000,'커피'),(103,'밥',1000,'메인'),(104,'라면',2000,'메인'),(105,'쿠키',500,'사이드');
...
INSERT INTO `주문` VALUES ('0000-00-00','선택안함','admin'),('2023-11-7','선택안함','cho'),('2023-11-7','선택안함','moon');
...
-- Dump completed on 2023-11-07  2:08:59

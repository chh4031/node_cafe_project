...
INSERT INTO `고객` VALUES ('cho','1111','조대수','NM103','01011112222'),('moon','2222','문미경','NM104','01022223333');
...
CREATE TABLE `메뉴단위` (
  ...
  `주문수량` int NOT NULL,
  `주문가격` int NOT NULL,
  PRIMARY KEY (`주문_주문날짜`,`메뉴항목_항목번호`,`고객_고객아이디`),
...
-- Dump completed on 2023-11-06 22:31:57
